...
const MedicalStepForm = () => {
  ...
  // Usar el hook actualizado que incluye availableDates, scroll automático, y navegación
  const {
    formData,
    updateField,
    pricing,
    ...
    availableDates,
    formContainerRef,
  } = useStepFormCalculator();

  // Definición de los steps
  const steps = [
    {
      num: 1,
      label: { es: "Información Personal", en: "Personal Information" },
    },
  ...
  const renderCurrentStep = () => {
    switch (currentStep) {
      ...
      case 2:
        return <ProcedureStep formData={formData} updateField={updateField} />;
      case 3:
        return (
          <DateStep
            formData={formData}
      ...
      case 6:
        return (
          <MedicalHistoryStep formData={formData} updateField={updateField} />
        );
      case 7:
        return <SummaryStep formData={formData} pricing={pricing} />;
      default:
        return null;
    }
  };
          ...
          >
            <div className="inline-flex items-center gap-2 bg-blue-500/10 px-5 py-2.5 rounded-full border border-blue-500/20 mb-6">
              ...
              <span className="text-sm font-bold text-blue-700 uppercase tracking-wider">
                {t({
                  es: "Calculadora Médica Internacional",
                  en: "International Medical Calculator",
                })}
              </span>
            </div>
            ...
            <p className="text-xl text-slate-600 font-light">
              {t({
                es: "Transparencia total en 7 pasos simples",
                en: "Total transparency in 7 simple steps",
              })}
            </p>
          </motion.div>
